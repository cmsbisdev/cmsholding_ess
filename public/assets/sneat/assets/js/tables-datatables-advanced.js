...
$(function () {
    ...
    function l(a, t) {
        var e, l, o, s, r;
        5 == a ? (e = d.val(), l = c.val(), "" !== e && "" !== l && ($.fn.dataTableExt.afnFiltering.length = 0, n.dataTable().fnDraw(), o = a, s = e, r = l, $.fn.dataTableExt.afnFiltering.push(function (a, t, e) {
            var t = i(t[o]),
                l = i(s),
                n = i(r);
    ...
    }), t.length && ($(".dt-column-search thead tr").clone(!0).appendTo(".dt-column-search thead"), $(".dt-column-search thead tr:eq(1) th").each(function (a) {
        var t = $(this).text();
