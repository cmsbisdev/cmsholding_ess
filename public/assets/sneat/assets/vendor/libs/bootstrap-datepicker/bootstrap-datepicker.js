                        ...
                        h.prototype = {
                            ...
                            fillDow: function () {
                                if (this.o.showWeekDays) {
                                    var e = this.o.weekStart,
                                        i = "<tr>";
                                    for (this.o.calendarWeeks && (i += '<th class="cw">&#160;</th>'); e < this.o.weekStart + 7;) i += '<th class="dow', -1 !== t.inArray(e, this.o.daysOfWeekDisabled) && (i += " disabled"), i += '">' + D[this.o.language].daysMin[e++ % 7] + "</th>";
                            ...
                            _fill_yearsView: function (i, a, s, n, o, r, h) {
                                for (var l, d, c, u = "", p = s / 10, f = this.picker.find(i), g = Math.floor(n / s) * s, D = g + 9 * p, m = Math.floor(this.viewDate.getFullYear() / p) * p, y = t.map(this.dates, (function (t) {
                                    ...
                                    })), v = g - p; v <= D + p; v += p) l = [a], d = null, v === g - p ? l.push("old") : v === D + p && l.push("new"), -1 !== t.inArray(v, y) && l.push("active"), (v < o || v > r) && l.push("disabled"), v === m && l.push("focused"), h !== t.noop && ((c = h(new Date(v, 0, 1))) === e ? c = {} : "boolean" == typeof c ? c = {
                                    enabled: c
                                } : "string" == typeof c && (c = {
                                    classes: c
                            ...
                            fill: function () {
                                var s, n, o = new Date(this.viewDate),
                                    ...
                                    y = a(),
                                    v = (!0 === this.o.todayBtn || "linked" === this.o.todayBtn) && y >= this.o.startDate && y <= this.o.endDate && !this.weekOfDateIsDisabled(y);
                                if (!isNaN(r) && !isNaN(h)) {
                                    this.picker.find(".datepicker-days .datepicker-switch").text(m.formatDate(o, g, this.o.language)), this.picker.find("tfoot .today").text(p).css("display", v ? "table-cell" : "none"), this.picker.find("tfoot .clear").text(f).css("display", !0 === this.o.clearBtn ? "table-cell" : "none"), this.picker.find("thead .datepicker-title").text(this.o.title).css("display", "string" == typeof this.o.title && "" !== this.o.title ? "table-cell" : "none"), this.updateNavArrows(), this.fillMonths();
                                    var w = i(r, h, 0),
                                        k = w.getUTCDate();
                                    ...
                                    for (var _, C, T = []; w.valueOf() < b;) {
                                        ...
                                        this.o.beforeShowDay !== t.noop && ((n = this.o.beforeShowDay(this._utc_to_local(w))) === e ? n = {} : "boolean" == typeof n ? n = {
                                            ...
                                            classes: n
                                        }), !1 === n.enabled && C.push("disabled"), n.classes && (C = C.concat(n.classes.split(/\s+/))), n.tooltip && (s = n.tooltip), n.content && (V = n.content)), C = t.isFunction(t.uniqueSort) ? t.uniqueSort(C) : t.unique(C), T.push('<td class="' + C.join(" ") + '"' + (s ? ' title="' + s + '"' : "") + ' data-date="' + w.getTime().toString() + '">' + V + "</td>"), s = null, _ === this.o.weekEnd && T.push("</tr>"), w.setUTCDate(w.getUTCDate() + 1)
                                    }
                                    ...
                                    if (t.each(this.dates, (function (t, e) {
                                        ...
                                        })), (r < l || r > c) && O.addClass("disabled"), r === l && O.slice(0, d).addClass("disabled"), r === c && O.slice(u + 1).addClass("disabled"), this.o.beforeShowMonth !== t.noop) {
                                        var A = this;
                            ...
                            p = function (i) {
                                ...
                                if (s.shift(), this.each((function () {
                                        ...
                                        if (!n) {
                                            ...
                                            }), n = new l(this, p)) : n = new h(this, p), e.data("datepicker", n)
                                        }
                        ...
                        var D = t.fn.datepicker.dates = {
                            ...
                            m = {
                                ...
                                parseDate: function (i, s, n, o) {
                                    ...
                                    if (i in f && (i = f[i]), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/i.test(i)) {
                                    ...
                                    if (r.length !== b.length && (b = t(b).filter((function (e, i) {
                                        ...
                                        for (c = 0, C = b.length; c < C; c++) {
                                            if (g = parseInt(r[c], 10), l = b[c], isNaN(g)) switch (l) {
                                                case "MM":
                                                    y = t(D[n].months).filter(_), g = t.inArray(y[0], D[n].months) + 1;
                                                    break;
                                                case "M":
                                                    y = t(D[n].monthsShort).filter(_), g = t.inArray(y[0], D[n].monthsShort) + 1
                                            }
                                            v[l] = g
                                        }
