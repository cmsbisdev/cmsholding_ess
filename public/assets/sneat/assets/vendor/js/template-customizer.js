                    ...
                    return e = t, s = [{
                        ...
                        value: function (t, e) {
                            ...
                            if ("number" == typeof document.documentMode && document.documentMode < 11) {
                                ...
                                var url = replace
                                // document.write('<link rel="stylesheet" type="text/css" href="'+url+'" class="'+t+'">');
                                document.write('<link rel="stylesheet" type="text/css" href="'.concat(url, '" class="').concat(t, '">'));
                        ...
                        value: function (t, e) {
                            ...
                            function a(t, e, s) {
                                var i = document.createElement("link");
                                var replace = t.replace("../", "/")
                                t = window.location.origin+replace
