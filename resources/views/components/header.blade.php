...
<title>CMS ESS - @yield('title')</title>
...
<link rel="stylesheet" href="{{ asset('assets/sneat/') }}/libs/datatables-bs5/datatables.bootstrap5.css">
<link rel="stylesheet" href="{{ asset('assets/sneat/') }}/libs/datatables-responsive-bs5/responsive.bootstrap5.css">
<link rel="stylesheet" href="{{ asset('assets/sneat/') }}/libs/datatables-checkboxes-jquery/datatables.checkboxes.css">
<link rel="stylesheet" href="{{ asset('assets/sneat/') }}/libs/datatables-buttons-bs5/buttons.bootstrap5.css">
<link rel="stylesheet" href="{{ asset('assets/sneat/') }}/assets/vendor/libs/flatpickr/flatpickr.css" />

<link rel="stylesheet" href="{{ asset('assets/sneat/') }}/assets/vendor/libs/bootstrap-datepicker/bootstrap-datepicker.css" />
